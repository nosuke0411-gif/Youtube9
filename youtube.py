...
<!DOCTYPE html>
<html><body>ログイン失敗しました。<a href="/login">戻る</a></body></html>
""")
...
def register():
    if request.method == "POST":
        ...
        try:
            ...
            return render_template_string("""
<!DOCTYPE html>
<html><body>そのユーザー名は既に使われています。<a href="/register">戻る</a></body></html>
""")
        conn.close()
...
<div class="container">
    ...
    <button onclick="alert('ここにスロットやテトリスを追加')">スロット（仮）</button>
    <button onclick="alert('ここに別のゲームを追加')">別のゲーム（仮）</button>
    <a href="/">変換ツールに戻る</a>
